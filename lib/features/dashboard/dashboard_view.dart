...
class _DashboardViewState extends ConsumerState<DashboardView> {
    ...
    return Scaffold(
                ...
                child: Stack(
                  ...
                  children: [
                    ...
                    if (Supabase
                            ...
                            .auth
                            .currentUser
                            ?.userMetadata?['pro_card_verified'] ==
                        false)
                      Positioned(
                        right: -2,
                        top: -2,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          await Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) => const SelectInterventionView(),
            ),
          );
          _loadData();
        },
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  context.appColors.accentGold.withOpacity(0.2),
                  context.appColors.accentGold.withOpacity(0.05),
                ],
  ...
  Widget _buildNewMissionCard(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [context.appColors.accentGold, const Color(0xFFC5942D)],
          begin: Alignment.topLeft,
          end: Alignment.bottomRight,
        ),
        borderRadius: BorderRadius.circular(24),
        boxShadow: [
          BoxShadow(
            color: context.appColors.accentGold.withOpacity(0.35),
            blurRadius: 20,
                ...
                if (_allHistory.isNotEmpty)
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: _showFilters
                            ? context.appColors.accentGold.withOpacity(0.1)
  ...
  Widget _buildRecentList() {
      ...
      return Container(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 4),
            Text(
              'ابدأ أول مهمة بالضغط على الزر أعلاه',
              style: TextStyle(
                fontSize: 13,
                color: context.appColors.textMuted,
              ),
    ...
    for (var item in _filteredHistory) {
      ...
      if (!grouped.containsKey(dossier)) {
        ...
        grouped[dossier]!['photo_count'] =
            (grouped[dossier]!['photo_count'] as int) + 1;
      }
    }
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        ...
        final interventionType =
            ...
            extractTypeFromNotes(item['notes'] ?? '');
