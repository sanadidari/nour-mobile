...
class GlossaryTerm {
  ...
  const GlossaryTerm({required this.termAr, required this.termFr});
}
...
const List<LawArticle> law8103Data = [
  ...
  LawArticle(
    ...
    title: 'إحداث المكاتب',
    content:
        '''تحدث بدوائر المحاكم الابتدائية مكاتب للمفوضين القضائيين للقيام بالمهام المنوطة بهم طبقا لهذا القانون أمام مختلف محاكم المملكة.''',
  ),
  LawArticle(
    id: '3',
    title: 'حالات التنافي',
  ...
  LawArticle(
    id: '4',
    title: 'شروط مزاولة المهنة',
    content: '''يشترط في المرشح لمزاولة مهنة مفوض قضائي :
...
9 - أن يكون قد نجح في المباراة لولوج مهنة المفوضين القضائيين، وأدى فترة التكوين ونجح في اختبار نهايته.''',
  ...
  LawArticle(
    id: '5',
    title: 'الإعفاء من المباراة',
    content: '''يعفى من المباراة فقط وفي حدود ثلث المكاتب الشاغرة :
...
- المحررون القضائيون وكتاب الضبط الذين أثبتوا أنهم قضوا على الأقل خمسة عشرة سنة من العمل المتواصل بالمحاكم والحاصلون على الشهادة المشار إليها في الفقرة الثالثة من المادة الرابعة أعلاه.''',
  ...
  LawArticle(
    id: '6',
    title: 'كيفية إجراء المباراة',
    content:
        '''تحدد كيفية إجراء المباراة والتكوين واختبار نهايته بنص تنظيمي.''',
  ),
  LawArticle(
    id: '7',
    title: 'مشتملات التكوين',
    content: '''يشتمل التكوين على تأهيل نظري وتطبيقي وميداني.''',
  ),
  LawArticle(
    id: '8',
    title: 'التشطيب لعدم الالتزام',
    content:
        '''يمكن لوزير العدل وباقتراح من هيئة التكوين أن يشطب على المتدرب الذي يكون قد أخل بالتزاماته.''',
  ),
  LawArticle(
    id: '9',
    title: 'الترخيص بالمزاولة',
    content:
...
تسلم وثائق الإجراءات أو نسخ منها إلى من له الحق فيها بناء على طلبه.''',
  ...
  LawArticle(
    id: '20',
    title: 'سجل كتابة الضبط',
    content:
        '''تمسك كتابة الضبط سجلا وفق نموذج يحدد بقرار لوزير العدل يؤشر على صفحاته رئيس المحكمة الابتدائية المختصة يتضمن الأسماء والعناوين الكاملة للمفوضين القضائيين الموجود محل إقامتهم بدائرة نفوذها وتاريخ التحاقهم بالمهنة، وأدائهم اليمين القانونية ومراجع مقررات تعيينهم، ونماذج من توقيعاتهم وإمضاءاتهم المختصرة.''',
  ),
  LawArticle(
    id: '21',
    title: 'اختيار المفوض',
...
ويمكن للمفوض القضائي الاحتفاظ بالوثائق بعد إذن من رئيس المحكمة إلى حين أداء أجرته.''',
  ...
  LawArticle(
    id: '24',
    title: 'علاقة المفوض بكتابة الضبط',
    content:
...
يمنع على المفوض القضائي أن يحجم عن تقديم المساعدة الواجبة للقضاء والمتقاضين بدون عذر مقبول، كما يمنع على المفوضين القضائيين التواطؤ لنفس الغاية.''',
  ...
  LawArticle(
    id: '31',
    title: 'موانع شخصية',
    content: '''يمنع على المفوض القضائي بصفة شخصية أو بواسطة الغير :
...
يخبر رئيس المحكمة المذكورة بعد ذلك وزير العدل وكذا الهيئة بإلحاق الكاتب المحلف بمكتب المفوض القضائي.''',
  ...
  LawArticle(
    id: '42',
    title: 'شروط الكاتب المحلف',
    content: '''يشترط في المترشح لمزاولة مهنة كاتب محلف ما يلي :
1 - أن يكون من جنسية مغربية ؛
...
يجب على المفوض القضائي إخبار رئيس المحكمة الابتدائية ووكيل الملك والهيئة التي ينتمي إليها بتخليه عن الكاتب المحلف أو استقالته.''',
  ...
  LawArticle(
    id: '48',
    title: 'عقد المشاركة',
    content: '''تبرم المشاركة بمقتضى عقد نموذجي يحدد بقرار لوزير العدل.
...
تسري حالة المنع المنصوص عليها في المادة 32 بالنسبة لأحد المفوضين القضائيين على باقي المتشاركين معه في نفس المكتب.''',
  ...
  LawArticle(
    id: '51',
    title: 'انتهاء المشاركة',
    content: '''تنتهي المشاركة بأحد الأسباب التالية :
...
- حكم قضائي.''',
  ...
  LawArticle(
    id: '52',
    title: 'العمليات والتصفية',
    content:
        '''تجرى عمليات تصفية المشاركة بحضور المفوضين القضائيين المتشاركين أو من يمثلهم تحت مراقبة وكيل الملك لدى المحكمة الابتدائية التي يمارس المفوضون القضائيون مهامهم بدائرة نفوذها، وكذا عضوين من الجهة التمثيلية لهيئة المفوضين القضائيين جهويا.
يمكن عند الاقتضاء، الاستعانة بمدقق الحسابات.
تثبت هذه العمليات في محضر.''',
  ),
  LawArticle(
    id: '53',
    title: 'العقوبات الجنائية',
    content:
...
ويتم تنظيم هذه الهيئة بنص تنظيمي.''',
  ...
  LawArticle(
    ...
    title: 'نسخ المقتضيات',
    content:
        '''تنسخ مقتضيات القانون رقم 41.80 بإحداث هيئة للأعوان القضائيين وتنظيمها الصادر بتنفيذه الظهير الشريف رقم 1.80.440 بتاريخ 17 من صفر 1401 (25 ديسمبر 1980) والظهير الشريف رقم 1.93.138 الصادر في 22 من ربيع الأول 1414 (10 سبتمبر 1993) المعتبر بمثابة قانون يغير ويتمم بموجبه القانون رقم 41.80 المتعلق بإحداث هيئة للأعوان القضائيين وتنظيمها.''',
  ),
  LawArticle(
    id: '59',
    title: 'سريان المفعول',
...
const List<DecreeArticle> decreeData = [
  ...
  DecreeArticle(
    id: '2',
    title: 'مواد المباراة',
    content: '''تشتمل المباراة على اختبارين كتابي وشفوي:
...
- عرض يتعلق بالقانون المنظم لمهنة المفوضين القضائيين، مدة تهييئه عشرون دقيقة بمعامل 1.''',
  ...
  DecreeArticle(
    id: '3',
    title: 'تقييم المباراة',
    content: '''تقيم كل مادة بدرجات تتراوح بين 0 و 20.
...
يرتب الناجحون لشغل المكاتب المتبارى عليها حسب الاستحقاق. إذا تساوى المترشحون في النقط المحصل عليها تم اللجوء إلى القرعة عند الاقتضاء.''',
  ...
  DecreeArticle(
    id: '4',
    title: 'تنظيم المباراة',
    content: '''تحدد كيفية تنظيم المباراة بقرار لوزير العدل.''',
  ),
  DecreeArticle(
    id: '5',
    title: 'فترة التكوين',
...
يجرى التكوين تحت إشراف المعهد العالي للقضاء طيلة فترة التكوين وكذا تحت مراقبة الوكيل العام للملك خلال مدة مقام المتدرب في محكمة أو لدى مفوض قضائي.''',
  ...
  DecreeArticle(
    id: '7',
    title: 'اختبار نهاية التكوين',
    content: '''يشتمل اختبار نهاية التكوين على اختبارين كتابي وشفوي.
يشتمل الاختبار الكتابي على:
...
- عرض يتعلق بالمعلوميات بمعامل 1.''',
  ...
  DecreeArticle(
    id: '8',
    title: 'تقييم اختبار النهاية',
    content: '''تقيم كل مادة بدرجات تتراوح بين 0 و 20.
لا يعتبر أيا كان في الترتيب النهائي إن لم يحصل على معدل لا يقل عن 60.''',
  ),
  DecreeArticle(
    id: '9',
    title: 'كيفية الاختبار',
    content: '''تحدد كيفية تنظيم اختبار نهاية التكوين بقرار لوزير العدل.''',
  ),
  DecreeArticle(
    id: '10',
    title: 'اللجنة المشرفة للمباراة',
    content: '''تتركب اللجنة المشرفة على المباراة واختبار نهاية التكوين من:
...
- رئيس الهيئة الوطنية للمفوضين القضائيين أو من ينتدبه لهذه الغاية.''',
  ...
  DecreeArticle(
    ...
    title: 'تعيين اللجنة',
    content:
        '''يعين وزير العدل أعضاء اللجنة المشرفة على المباراة واختبار نهاية التكوين وكذا نوابا لهم بقرار.''',
  ),
  DecreeArticle(
    id: '12',
    title: 'تأليف اللجنة المادة 9',
    content: '''تتألف اللجنة المذكورة في المادة 9 من القانون 81.03 من:
- مدير الشؤون المدنية بصفته رئيسا ؛
...
- المجالس الجهوية للمفوضين القضائيين.''',
  ...
  DecreeArticle(
    ...
    content: '''الجمعية العامة هي أعلى جهاز يحدد التوجهات الكبرى للهيئة.
...
يرجح في الانتخاب عند تعادل الأصوات المفوض القضائي الأقدم ممارسة في المهنة.''',
  ...
  DecreeArticle(
    id: '25',
    title: 'شروط الترشح للرئاسة',
    content:
        '''يشترط في المترشح لرئاسة الهيئة الوطنية للمفوضين القضائيين الشروط التالية:
- أن تكون له صفة ناخب ؛
...
على أنه إذا كان عدد المفوضين القضائيين المسجلين على صعيد محكمة الاستئناف يقل عن خمسة وثلاثين مفوضا قضائيا فإنهم يلحقون بالمجلس الجهوي لأقرب محكمة استئناف.''',
  ...
  DecreeArticle(
    id: '39',
    title: 'شروط عضوية المجلس الجهوي',
    content: '''يشترط في المترشح لعضوية مكتب المجلس الجهوي الشروط التالية:
- أن تكون له صفة ناخب ؛
...
يوجه الدعوة للانعقاد اجتماع مكتب المجلس الجهوي، يحدد جدول أعماله ويتولى تنفيذ المقررات الصادرة عنه، وله أن يفوض بعض صلاحياته إلى أحد أعضاء المكتب.''',
  ...
  DecreeArticle(
    id: '47',
    title: 'اجتماع واختصاص اللجان',
    content: '''تجتمع اللجان المذكورة مرة واحدة في السنة على الأقل.
...
const List<GlossaryTerm> glossaryData = [
  ...
  GlossaryTerm(
    termAr: 'محكمة ابتدائية',
    termFr: 'Tribunal de Première Instance',
  ),
