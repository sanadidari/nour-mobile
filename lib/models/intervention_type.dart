...
const List<GharadOption> mofawadGharadOptions = [
  GharadOption(
    title: 'مسطرة التبليغ',
    description: 'تهدف مسطرة التبليغ إلى إيصال الاستدعاءات والوثائق القضائية إلى ذوي الشأن بصفة قانونية. تضمن هذه العملية إعلام الأطراف بمواعيد الجلسات والأحكام الصادرة في حقهم لضمان حقوق الدفاع. يقوم المفوض القضائي بتحرير محضر رسمي يثبت عملية التسليم أو التعذر وفق الضوابط المسطرية.',
    fields: [
  ...
  GharadOption(
    title: 'مسطرة التنفيذ',
    description: 'تعتبر مسطرة التنفيذ الجبري المرحلة الحاسمة لتحويل الأحكام القضائية من نصوص مكتوبة إلى واقع ملموس. تشمل هذه العملية إجراءات الحجز، البيع بالمزاد العلني، أو الإفراغ، وذلك لاستخلاص الحقوق لفائدة المحكوم لهم.',
    fields: [
...
const Map<String, List<String>> northCityData = {
  'طنجة': ['وسط المدينة', 'طنجة المدينة', 'بني مكادة', 'مغوغة', 'مالاباطا', 'مسنانة', 'طنجة مارينا', 'البرانص', 'مرس الخير'],
  'تطوان': ['وسط المدينة', 'تطوان المدينة', 'سانية الرمل', 'حي الولاية', 'الملايين', 'بوجراح', 'الملاح', 'كويلمة', 'الخلوة'],
  'العرائش': ['وسط المدينة', 'العرائش المدينة', 'حي الميناء', 'المنار', 'مولاي عبد السلام'],
  ...
  'شفشاون': ['المدينة القديمة', 'شفشاون المدينة', 'رأس الماء', 'باب برد', 'تارجيست'],
  'وزان': ['وسط المدينة', 'حي القشريين', 'وزان المدينة'],
  'الحسيمة': ['وسط المدينة', 'حي صباديا', 'تالا يوسف', 'الحسيمة المدينة', 'إمزورن', 'بني بوعياش'],
